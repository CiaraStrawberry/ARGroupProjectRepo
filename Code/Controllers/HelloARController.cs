...
namespace GoogleARCore.Examples.HelloAR
{
    ...
    public class HelloARController : MonoBehaviour
    {
        ...
        public static event SpawnAction spawnedObj;
        ...
        public void Update()
        {
            ...
            if (Frame.Raycast(touch.position.x, touch.position.y, raycastFilter, out hit))
            {
                ...
                else
                {
                    ...
                    var andyObject = Instantiate(AndyAndroidPrefab, AndyAndroidPrefab.transform.position, AndyAndroidPrefab.transform.rotation);
